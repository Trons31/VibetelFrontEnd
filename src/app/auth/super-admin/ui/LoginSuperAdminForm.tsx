...
export const LoginSuperAdminForm = () => {
    ...
    useEffect(() => {
        if (state === "Success;") {
            window.location.replace("/admin/dashboard-super-admin");
        }
    }, [state])

    return (
        <form onSubmit={handleSubmit(onDispatch)} className="w-full max-w-md items-center mt-10 md:mt-10  bg-white ">
