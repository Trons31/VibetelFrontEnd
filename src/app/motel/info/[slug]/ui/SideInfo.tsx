...
import { Motel, MotelInfo } from '@/interfaces';
...
export const SideInfo = ({ motel }: Props) => {
    ...
    return (
        <div className='px-3 md:col-span-3' >
            ...
            <div className='bg-white shadow-xl border border-gray-300 rounded-3xl p-8 flex  justify-between ' >
                <div className='' >
                    ...
                    <p className='font-semibold text-center capitalize text-lg mt-2' >{motel.title}</p>
                ...
                <div className='space-y-5'>
                    <div className='flex gap-2 items-center'>
                        ...
                        <p className='font-extralight text-sm break-words whitespace-normal'>
                            {motel.country}, {motel.department}, {motel.city}
                        </p>
                    </div>
...

                {
                    motel.amentiesMotelMap.length > 0 ? (
                        motel.amentiesMotelMap.map((amenitieMotel, index) => {
                            // Define un mapa de íconos para las comodidades específicas
                            ...
                            return (
                                <div key={index} >
                                    <div className='flex gap-2 items-center mb-4'>
                                        {/* Muestra el ícono correspondiente o un ícono genérico */}
