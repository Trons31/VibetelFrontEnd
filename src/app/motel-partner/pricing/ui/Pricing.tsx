            ...
            <div className="flex justify-center mt-10">
                <div className="inline-flex rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                    ...
                    >
                        ...
                        Anualidad
                        <span className="ml-2 text-xs md:text-xs bg-red-500 text-white px-2 py-0.5 rounded-full">
                            <TiArrowDownThick />
                        </span>
                    </button>
                </div>
            ...
            <div className="px-4 md:px-10 2xl:px-64">
                <div className="mt-10 md:mt-10 grid w-full grid-cols-1 items-stretch gap-7 sm:mt-10 sm:gap-y-0 lg:grid-cols-4">
                    {plans.map((plan, index) => (
                        <div
                            key={index}
                            className="relative flex flex-col bg-white py-8 px-6 rounded-3xl shadow-lg ring-1 ring-black hover:ring-gray-700 transition-all duration-300 h-full"
                        >
                            <h3 className="text-xl font-bold text-black mb-4">{plan.name}</h3>

                            {plan.isPopular && (
                                <div className="absolute top-0 right-0 -mt-3 mr-6 bg-black text-white text-sm font-bold px-4 py-1 rounded-full shadow-md">
                                    Más popular
                                </div>
                            )}
                            ...
                            <Link
                                href="/motel-partner"
                                className="flex justify-center w-full bg-black text-white font-semibold py-3 px-6 rounded-xl transition-colors duration-300 transform hover:scale-[1.02] shadow-md"
                            >
                                {plan.ctaText}
                            </Link>
