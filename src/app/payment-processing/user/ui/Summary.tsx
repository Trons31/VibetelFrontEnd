...
import { calculateTotalPrice, currencyFormat, calculateFees } from '@/utils';
import { BsBagCheck } from 'react-icons/bs';
import { LuShieldCheck } from 'react-icons/lu';
import { ModalPopup, PayUser, PayUserMovil } from '@/components';
...
export const Summary = () => {
    ...
    const { totalFees } = calculateFees(summary.promPrice ? summary.promPrice : summary.price);
            ...
            <div className="bg-white w-full md:rounded-md px-4 md:px-4 py-3">
                ...
                <div className="hidden md:flex justify-center mt-1 mb-3">
                    <p className="text-xs text-center">
                        Al hacer clic en confirmar reserva aceptas <a href="#" className="underline text-blue-600">términos y condiciones</a> y <a href="#" className="underline text-blue-600">política de privacidad</a>
                    </p>
                </div>
            </div>
