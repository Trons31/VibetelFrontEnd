...
export const RoomInBooking = () => {
  ...
  const arrivalDateAwait = roomInBooking?.arrivalDate
    ? new Date(
      new Date(roomInBooking.arrivalDate).setMinutes(
        new Date(roomInBooking.arrivalDate).getMinutes() +
        roomInBooking.timeAwait
      )
    )
    : null;
    ...
    <>
      ...
      <div className="md:rounded-sm bg-white px-4 py-6 mt-5">
        ...
        <div className="mt-3">
          ...
          <div className="grid grid-cols md:grid-cols-2 mt-3">
            <div>
              {loading && !roomInBooking ? (
                <div className="flex justify-start">
                  <svg
            ...
            <div className="md:grid block md:grid-cols-2 mt-5 space-y-4 md:mt-0 md:space-y-0">
              <div>
      ...
      <div className="md:rounded-sm bg-white px-4 py-6 mt-5">
        ...
        {loading && !roomInBooking ? (
          <div className="flex justify-end">
            <div className="w-full h-32 mb-2 bg-gray-400 rounded-md animate-pulse"></div>
          </div>
        ) : (
          <div className="border-l-8 mt-4 border-purple-600 bg-purple-200 px-4 py-2 rounded-l-lg">
            ...
            >
              ...
              <strong> {formatTime(roomInBooking?.timeAwait!)} </strong> es
              decir que si no tomas a tiempo tu servicio el motel te esperara
              hasta las{" "}
              <strong> {formatTimeWithAmPm(arrivalDateAwait!)} </strong> despues
              de esta hora tu reserva sera cancelada automaticamente{" "}
            </p>
          </div>
        )}
      </div>
