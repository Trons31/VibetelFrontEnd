...
export const TopMenuNotRegistered = () => {
  const router = useRouter();

  return (
    <nav className="flex fixed px-3 md:px-12 z-20 top-0 py-4 md:py-2 items-center bg-white w-full border-b border-gray-100 shadow-sm">
