...
export const ModalEnabled = ({ isOpen, onClose, nameRoom, idRoom }: ModalProps) => {
        ...
        <>
            ...
            >
                <div className="bg-white rounded-lg shadow-lg w-11/12 md:w-1/2 lg:w-1/2 p-6 max-h-full overflow-y-auto">
                    ...
                    <p className="mt-4 text-center text-xl font-bold">Confirmar Activación</p>
                    <p className="mt-2 text-center text-lg" style={{ textAlign: 'justify' }}>¿Estás seguro de que deseas activar la habitación <span className="truncate font-medium capitalize"> {nameRoom} </span>? Una vez activada, aparecerá como disponible enseguida para los usuarios en la plataforma.</p>
