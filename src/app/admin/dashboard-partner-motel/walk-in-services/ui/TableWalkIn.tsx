...
import { getServiceByMotel } from '@/actions';
...
export const TableWalkIn = ({ motelId, serviceData }: Props) => {
    ...
    const fetchReservations = useCallback(async () => {
        setIsFetching(true);
        const data = await getServiceByMotel({ motelId, searchQuery, statusFilter, date, page, limit: 10 });
        ...
        <>
            ...
            <div className="bg-gray-50 pb-5 rounded-xl">
                ...
                <div className="mx-auto rounded-md pt-5 mb-10">
                    <div className="grid grid-cols-8 items-center px-5 ">
                        <div className='col-span-6'>
                            <h1 className="text-2xl font-bold text-gray-900">Gestión de todos los servicios</h1>
                            <p className="text-xs text-gray-500">
                                Aquí podrás ver todos los servicios realizados en tiempo real. <strong>Para cargar más servicios, simplemente desplázate hacia abajo.</strong>
                            </p>
                        </div>
                ...
                <div className='px-2 mt-4' >
                    <FilterTableServices onFilterChange={handleFilterChange} />
                </div>
