...
import { createAdditionalSettingsMotel } from "@/actions";
...
export const AdditionalSettingsForm = ({ motelId, motelConfig }: Props) => {
    ...
    const onCreateSettingsMotel = async () => {
        ...
        const createSettingsMotel = await createAdditionalSettingsMotel(optionTimeLimitAwait, optionTimeCleanRoom, optionTimeAddReservation, motelId);

        if (!createSettingsMotel.ok) {
    ...
    return (
        <>
            ...
            <div className="overflow-hidden rounded-xl bg-white px-8 shadow">
                <div className="border-b pt-4 pb-8">
                    <div>
                        <h1 className="text-2xl font-bold">Ajustes adicionales</h1>
                        <BreadCrumb
                ...
                <div className="grid border-b py-6 sm:grid-cols-3">
                    <div className="col-span-2">
                        <h2 className="text-lg font-bold">Tiempo de espera límite</h2>
                ...
                <div className="grid border-b py-6 sm:grid-cols-3">
                    <div className="col-span-2">
                        <h2 className="text-lg font-bold">Tiempo de limpieza de una habitación</h2>
                        <p className="text-sm text-gray-800">
                ...
                <div className="grid border-b py-6 sm:grid-cols-3">
                    <div className="col-span-2">
                        <h2 className="text-lg font-bold">Tiempo de Adición Estándar</h2>
                        <p className="text-sm text-gray-800">
                ...
                <div className="grid grid-cols-3  mt-5  items-center pb-5 gap-5" >
