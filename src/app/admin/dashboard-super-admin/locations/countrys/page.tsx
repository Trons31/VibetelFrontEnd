...
import { TableClountrys } from "./ui/TableCountrys";
            ...
            <div className="bg-white rounded-xl mb-10"  >
                <div className="pb-10 py-10" >
                    <div className="px-2 md:mx-5" >
                        <p className="text-lg md:text-2xl font-bold" >Paises</p>
                        <BreadCrumb
                            breadcrumbCurrent="Paises"
                            urlCurrent="/admin/dashboard-super-admin/locations/countrys"

                            breadcrumbStart="dashboard"
                            urlStart="/admin/dashboard-super-admin"
                        />
                        <p className="text-xs md:text-sm mt-1" style={{ textAlign: 'justify' }}>
                            En esta sección podrás gestionar todos los paises registrados en la plataforma.
                        </p>
                    </div>
