      ...
      <header className="sticky top-0 flex w-full bg-white border-gray-200 z-40 lg:border-b">
        <div className="flex  items-center justify-between w-full gap-2 px-2 py-3 border-b border-gray-200 sm:gap-4  lg:border-b-0 lg:px-5 lg:py-4">
          ...
          <div className="flex items-center gap-2" >
            <button
              className="flex items-center justify-center w-10 h-10 text-gray-500 border-gray-200 rounded-lg z-[100000] lg:h-11 lg:w-11 lg:border" // Hacer visible en movil, ocultar en desktop
              onClick={handleToggle}
              aria-label="Toggle Sidebar"
            >
              {isMobileOpen ? (
                // Icono de "X" cuando el sidebar móvil está abierto
                <svg
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
                ...
                // Icono de hamburguesa cuando el sidebar móvil está cerrado
                <svg
                  width="16"
                  height="12"
                  viewBox="0 0 16 12"
