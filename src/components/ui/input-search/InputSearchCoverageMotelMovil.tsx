...
export const InputSearchCoverageMotelMovil = ({ onSearchTerm }: Props) => {
    ...
    return (
        <>
            ...
            {
                query !== '' && (
                    <div className='flex px-2 gap-2 items-center mb-4' >
                        <p className='text-sm font-medium' >Busquedad:</p>
