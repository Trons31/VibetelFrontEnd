        ...
        <ol className="relative border-s ml-3 border-gray-400 space-y-16 py-5">
            {reservation.ServiceItem?.serviceCompleted && (
                <li className="ms-4">
                    ...
                    <h3 className="text-lg font-semibold">Servicio Finalizado</h3>
            ...
            {addTimes.length > 0 &&
                addTimes.map((addTime, index) => (
                    <li className="ms-4" key={addTime.id}>
                        ...
                        <h3 className="text-lg font-semibold">Adición de tiempo</h3>
                        <p className="text-sm md:text-base font-extralight">
            ...
            {reservation.ServiceItem?.canceledReservation === false && reservation.ServiceItem?.serviceTaken && addTimes.length > 0 && reservation.ServiceItem.serviceCompleted && (
                <li className="ms-4">
                    ...
                    <h3 className="text-lg font-semibold">Servicio iniciado</h3>
                    <p className="text-sm md:text-base font-extralight">
            ...
            {reservation.ServiceItem?.canceledReservation && (
                <li className="ms-4">
                    ...
                    <h3 className="text-lg font-semibold">Reserva cancelada</h3>
                    <p className="text-sm md:text-base font-extralight">
...

            {
                ...
                reservation.ServiceItem?.serviceTaken === false && reservation.ServiceItem.status !== "no_iniciado" && (
                    <li className="ms-4">
                        ...
                        <h3 className="text-lg font-semibold">Reserva realizada</h3>
                        <p className="text-sm md:text-base font-extralight">
...

            {
                reservation.ServiceItem?.status === "no_iniciado" && (
                    <li className="ms-4">
                        ...
                        <h3 className="text-lg font-semibold">Reserva cancelada por el sistema</h3>
                        <p className="text-sm md:text-base font-extralight">
