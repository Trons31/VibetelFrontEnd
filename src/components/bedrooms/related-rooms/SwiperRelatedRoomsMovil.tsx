...
export const SwiperRelatedRoomsMovil = ({ rooms, className }: Props) => {
      ...
      >
        {rooms.map((room) => (
          <SwiperSlide key={room.slug}>
            <div
              className={`${styles["card-content"]}  fade-in bg-white border border-transparent mb-10
          hover:border-gray-300 hover:shadow-lg h-[380px] rounded-lg`}
            >
              <div className={`${styles["image-container"]} relative group`}>
                ...
                <div className="p-2 flex md:hidden rounded-b-sm md:group-hover:flex bg-red-600  justify-center  absolute right-0 bottom-0 w-full md:group-hover:bg-red-600 md:group-hover:transition-all md:group-hover:duration-300">
                  <p className="text-white md:text-red-600 md:group-hover:text-white font-normal text-xs md:text-lg">
                    Reservar ahora
                  </p>
                </div>
              </div>
                ...
                <div className="">
                  ...
                  <p className="text-sm text-gray-700 -mt-1">
                    ...
                    <button
                      ...
                      className="underline inline-block max-w-[100px] whitespace-nowrap overflow-hidden text-ellipsis align-bottom"
